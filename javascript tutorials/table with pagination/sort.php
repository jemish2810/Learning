...
<body>
   ...
   ?>
    ...
    <script>
        ...
        var jArray = <?php echo json_encode($url_var); ?>;
        var page = jArray['page'];
        var limit = jArray['limit'];
        var search = document.getElementById('search').value;
        var order= jArray['order'];
        var column = jArray['column'];
        
        function change(column){
            
            var url = 'sort.php?php='+page+'&limit='+limit+'&search='+search+'&column='+column+'&order='+order;
